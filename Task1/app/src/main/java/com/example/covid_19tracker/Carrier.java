...
public class Carrier {
    ...
    public Carrier(String name, String active, String confirmed, String migratedother, String deceased, String recovered, String dconfirmed, String ddeceased, String drecovered) {
        this.name = name;
        this.active = active;
